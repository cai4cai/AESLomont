...
// todo - make faster 128 blocksize version with 128 blocksize hardcoded as
// necessary
...
// TODO - test against the attack at http://cr.yp.to/mac/variability1.html and
// make fixes if necessary
...
#define VEC4(a, b, c, d)                                        \
  static_cast<unsigned long>(((long)(a)) | (((long)(b)) << 8) | \
                             (((long)(c)) << 16) | (((long)(d)) << 24))
...
void AES::EncryptBlock(
    ...
    unsigned char* dataout1) {  // todo ? allow in place encryption
